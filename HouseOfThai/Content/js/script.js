...
var userAgent = navigator.userAgent.toLowerCase(),
  ...
  plugins = {
    pointerEvents: isIE < 11 ? "./Content/js/pointer-events.min.js" : false,
    smoothScroll: $html.hasClass("use--smoothscroll") ? "./Content/js/smoothscroll.min.js" : false,
            ...
            onInit: function (map) {
              ...
              if (inputAddress.length) {
                ...
                var marker = new google.maps.Marker(
                  {
                    map: map,
                    icon: "./Content/images/gmap_marker.png",
                  }
                );
